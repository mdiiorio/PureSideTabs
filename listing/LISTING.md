...
• Drag-and-drop tabs for arrangement

Usage

1. Install from the Chrome Web Store
2. Ctrl-B (Command-B on Mac) to show sidebar
3. Ctrl-E (Command-E on Mac) to show popup menu, arrow keys or j/k to navigate
...
• You can use the popup menu to easily switch back and forth between two tabs: showing the popup menu, then pressing enter will switch back to your last viewed tab.